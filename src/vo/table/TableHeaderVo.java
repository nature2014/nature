...
public class TableHeaderVo {
    ...
    private Object[][] searchOptions = null; // map html select element, like [["1","2"]["Male","Female"]]
    ...
    public TableHeaderVo addSearchOptions(Object[][] searchOptions) {
        this.searchOptions = searchOptions;
        return this;
    }
        ...
        if (rawValue == null) {
            ...
            for (int i = 0; i < this.searchOptions[0].length; i++) {
                if (this.searchOptions[0][i].equals(String.valueOf(rawValue))) {
                    return this.searchOptions[1][i].toString();
                }
            }
