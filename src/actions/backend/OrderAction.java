...
public class OrderAction extends BaseBackendAction<OrderBusiness> {
    ...
    public TableInitVo getTableInit() {
        ...
        init.getAoColumns().add(new TableHeaderVo("createTime_lteq", "到").setHiddenColumn(true).enableSearch());
        ...
        init.getAoColumns().add(new TableHeaderVo("payDate_lteq", "到").setHiddenColumn(true).enableSearch());
