...
<script type="text/javascript"
        src="http://api.map.baidu.com/api?v=2.0&ak=<s:property value="@util.ServerContext@getValue(@util.DBUtils@getDBFlag()+@wechat.utils.Constants@MAP_TOKEN)"/>"></script>
...
<script type="text/javascript">
    try {
        ...
        function mapMutiplePosition(destination, lng, lat, detail) {
            if (lng != "" && lat != "") {
                var point = new BMap.Point(lng, lat);
                map.centerAndZoom(point, 10);
                ...
                var infoWindow = new BMap.InfoWindow(detail);  // 创建信息窗口对象
