...
<body class="wsd_type_home wsd_tpl_t22" wsd-title="点击进入霞珍集团官网" wsd-icon="http://dzr.cyznj.com/pages/wechat/image_52bb959d040ca120540276.jpg" wsd-link="http://fanersai.wxshidai.com/index?wxsd=mp.weixin.qq.com" wsd-desc="        凡尔赛建材馆是由宣威傲龙投资建设，主要用于建材家居销售。经营品类涵盖陶瓷、卫浴、洁具、灯具、电器、木地板、家居、窗帘、橱柜、集成吊顶、窗帘、壁纸等，真正打造了方便消费者一站式采购的大型建材家居服务中心。">
<!-- 音乐控件 -->
<style type="text/css">
    .music_play{ width:40px; height:30px; position:absolute; top:20px; left:15px; z-index:9999; background:url(http://dzr.cyznj.com/pages/wechat/playvoice.png) no-repeat; background-size:100%;  background-position: 0 0 ; }
    .posi{ background-position: 0 -36px;}
</style>
<div class="music_play" id="music_play">
    <audio  preload="auto" id="musicBoxtwo" src="http://dzr.cyznj.com/pages/wechat/voice_52bbf210a949b476214841.mp3" loop autoplay></audio>
</div>
...
<div class="wsd_page">
    ...
    <div class="wsdbannerbox">
        <div class="wsdbanner" id="wsdBanner" data-img-list="" style="height: 500px;">
            <div class="ui-txt">
                <p class="fn-hide" data-img-list="http://dzr.cyznj.com/pages/wechat/20140718153735862.jpg?ver"  data-img-link="">霞珍集团</p>
                <p class="fn-hide" data-img-list="http://dzr.cyznj.com/pages/wechat/20140718153806580.jpg?ver"  data-img-link="">霞珍集团</p>
                <p class="fn-hide" data-img-list="http://dzr.cyznj.com/pages/wechat/20140913150553448.jpg?ver"  data-img-link="">霞珍集团</p>
            </div>
    ...
    <div class="weishidai-content tpl-catelist" id="wsdBodyer" style="overflow:hidden;">
        <div class="tpl-catelist-item">
            <a href="http://dzr.cyznj.com/wechat/serviceDescription.action" class="weishidai_item tpl-catelist-item-body c0">
                <div class="weishidai_img">
                    <img src="http://dzr.cyznj.com/pages/wechat/Logo.png" class="tpl-cate-icon" />
                </div>
        ...
        <a href="http://dzr.cyznj.com/wechat/productList.action" class="weishidai_item tpl-catelist-item-body c1">
            <div class="weishidai_img">
                <img src="http://dzr.cyznj.com/pages/wechat/image_52bbdce701046067416082.jpg" class="tpl-cate-icon" />
            </div>
            <div class="weishidai_text">
    ...
    <%--</div>--%>
    <div class="tpl-catelist-item">
        <a href="http://dzr.cyznj.com/pages/wechat/contact.jsp" class="weishidai_item tpl-catelist-item-body c4">
            <div class="weishidai_img">
                <img src="http://dzr.cyznj.com/pages/wechat/image_52bbdbb8b171a042007120.jpg" class="tpl-cate-icon" />
            </div>
            <div class="weishidai_text">
    ...
    <div class="wsd-footer" id="wsdFooter">
        <a class="ui-support fn-clear" href="">
            <span class="fn-left" data-href="" style="width:40%"  >技术支持:微锤子</span>
            <span class="fn-right" data-href="http://dzr.cyznj.com/pages/wechat/" style="width:60%;text-align:right;"  >©2014-2015版权所有</span>
        </a>
    </div>
    <script type="text/javascript">
...
<script type="text/javascript">
    som.use(['module_phone/phineFlower.js', 'tool'], function(phineFlower, tool){
        phineFlower(10, 'http://dzr.cyznj.com/pages/wechat/lh.png');
    });
</script>
<!-- /首页动画 -->
</body>
