...
<section class="panel">
    ...
    <form id="customer" class="form-horizontal tasi-form" action="" method="post">
        <div class="panel-body">
            <label class="col-lg-2 control-label">请选择客户发送短信</label>
            ...
            success: function (result) {
                ...
                if ($.isArray(data)) {
                    for (var j = 0; j < data.length; j++) {
                        ...
                        checkboxList.push('<input type="checkbox" name="customer.cellPhone" value = "' + data[j].cellPhone + '" >');
